...
def test(args,config):
    ...
    test_dataset =  MedKLIP_Dataset(config[file_key],config['label_file'],modfilter=[0,1,1,0]) 
    ...
    xlsx_folder_path = '/remote-home/mengxichen/UniBrain-lora/Test/xlsx_files_b_m23/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='/remote-home/mengxichen/UniBrain-lora/Pretrain/output_missft/output_mod23v1/best_val.pth')
