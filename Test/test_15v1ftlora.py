...
def test(args,config):
    ...
    xlsx_folder_path = '/root/UniBrain-lora/Test/xlsx_files_loraproj_ft1/'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='/root/output_fifteen/output_loraproj_ft1/best_val.pth')
